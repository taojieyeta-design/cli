...
func TestSlidesScreenshotWritesFilesAndSuppressesBase64(t *testing.T) {
	...
	if !strings.HasSuffix(item["path"].(string), filepath.Join("shots", "pres_abc_slide_1.png")) {
	...
	if !strings.HasSuffix(item2["path"].(string), filepath.Join("shots", "pres_abc_p002_slide_2.jpg")) {
